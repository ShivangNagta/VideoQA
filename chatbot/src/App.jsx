...
import { Upload, Send, Video, MessageCircle, CheckCircle, Clock, FileVideo } from 'lucide-react';
...
const sendQuestion = async () => {
  ...
  try {
    const res = await fetch('http://localhost:8000/llava', {
      ...
      body: JSON.stringify({ question }),  // just the query
    });
    ...
    <div className="min-h-screen bg-gradient-to-br from-neutral-900 via-zinc-800 to-neutral-900">
      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-8">
          ...
          {/* Chat Section */}
          <div className="bg-white/5 backdrop-blur-md rounded-2xl border border-white/10 p-6 flex flex-col h-[600px]">
            <div className="flex items-center gap-3 mb-6">
            ...
            <div className="flex-1 overflow-y-auto space-y-4 mb-6 pr-2">
              {chat.length === 0 ? (
                <div className="text-center py-12">
                  ...
                  <p className="text-slate-400">Upload a video and start asking questions about its content</p>
                </div>
              ) : (
                chat.map((msg, idx) => (
            ...
            <div className="flex gap-3">
              <input
                type="text"
                placeholder={isVideoReady ? "Ask a question about the video..." : "Upload a video first"}
                value={question}
